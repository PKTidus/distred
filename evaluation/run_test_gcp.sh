...
echo "Sleeping to ensure all data is flushed"
...
locust -f locustfile.py --headless --host http://34.106.167.192  --csv haproxy_remote --only-summary

python3 graph_results.py go_remote_stats_history.csv nginx_remote_stats_history.csv haproxy_remote_stats_history.csv "Go Server" "Nginx" "HA Proxy"