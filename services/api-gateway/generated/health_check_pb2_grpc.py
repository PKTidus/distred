...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in health_check_pb2_grpc.py depends on'
...
class HealthCheckServiceStub(object):
    """Simple health check service to monitor CPU and memory usage of each api gateway instance.
    """
...
class HealthCheckServiceServicer(object):
    ...
    def Check(self, request, context):
        """Returns current CPU and memory usage percentages for the instance.
        """
...
def add_HealthCheckServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('healthcheck.HealthCheckService', rpc_method_handlers)
